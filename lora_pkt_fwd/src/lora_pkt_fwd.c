...
int main(void)
{
    ...
    char *global_cfg_path= "/usr/share/doc/lora-pkt-fwd/global_conf.json"; /* contain global (typ. network-wide) configuration */
    char *local_cfg_path = "/usr/share/doc/lora-pkt-fwd/local_conf.json"; /* contain node specific configuration, overwrite global parameters for parameters that are defined in both */
    char *debug_cfg_path = "/usr/share/doc/lora-pkt-fwd/debug_conf.json"; /* if present, all other configuration files are ignored */
